      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/5 py-20 px-4">
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          <div className="animate-fade-in-up">
            <div className="mb-8 flex justify-center">
              ...
              >
                <Image src="${BASE_PATH}/icon.png" alt="TagLink アプリアイコン" width={64} height={64} className="h-16 w-16" />
              </div>
            </div>
        ...
        <div className="container mx-auto max-w-4xl mt-16 animate-on-scroll">
          ...
          >
            ...
            <Image
              src="${BASE_PATH}/screenshot.png"
              alt="TagLink アプリケーション画面"
              width={1920}
              height={1080}
              className="w-full h-auto rounded-lg shadow-2xl border border-border hover:shadow-3xl transition-shadow duration-500"
            />
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-3 mb-4 md:mb-0">
              <div className="h-8 w-8 rounded bg-primary/10 flex items-center justify-center">
                <Image src="${BASE_PATH}/icon.png" alt="TagLink" width={24} height={24} className="h-6 w-6" />
              </div>
              <span className="text-xl font-bold text-primary">TagLink</span>
            </div>
            <div className="text-sm text-muted-foreground">© 2025 TagLink. All rights reserved.</div>
          </div>
        </div>
      </footer>
    </div>
